...
public:
     ...
     */
    [[nodiscard]] bool saveKeys(const std::string &publicKeyPath, const std::string &privateKeyPath) const;
     ...
     */
    bool loadKeys(const std::string &publicKeyPath, const std::string &privateKeyPath);
